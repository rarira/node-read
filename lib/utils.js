...
var regexps = {
  ...
  positiveRe: /interview|question|answer|news_img|image|photo|article|body|content|entry|hentry|page|pagination|post|text|cont_txt|aricle|image_src/i,
...
function getCandidates($, base, options) {
  ...
  $('*', 'body').each(function(index, element) {
    ...
    if (base) {
      ...
      if (nodeType == 'img' && typeof node.data('src') != 'undefined') {
