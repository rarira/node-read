...
var regexps = {
  ...
  positiveRe: /photo|article|body|content|entry|hentry|page|pagination|post|text|cont_txt|aricle/i,
  negativeRe: /landing_boxㅣart_btm|news_like|news_rel|news_copyright_links|art_btm|list|twobox|like|rel|links|emotion|table|arl_view|writer|date|combx|comment|captcha|contact|foot|footer|footnote|link|media|meta|promo|related|scroll|shoutbox|sponsor|utility|tags|widget|tip|dialog|title|ad|Ad|tit|subject/i,
