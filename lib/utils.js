...
var regexps = {
  ...
  negativeRe: /art_btm|list|twobox|photo|like|rel|links|emotion|table|arl_view|writer|date|combx|comment|captcha|contact|foot|footer|footnote|link|media|meta|promo|related|scroll|shoutbox|sponsor|utility|tags|widget|tip|dialog|title|ad|Ad|tit|subject/i,
...
function getCandidates($, base, options) {
  ...
  $('*', 'body').each(function(index, element) {
    ...
    if (base) {
      ...
      if (nodeType == 'img' && node.attr('data-src')) {
        node.attr('src', node.attr('data-src'));
      }
      if (nodeType == 'img' && node.attr('onerror')) {
