...
var regexps = {
  ...
  okMaybeItsACandidateRe: /and|article|body|column|main|figure/i,
  positiveRe: /ab_photo|caption|interview|question|answer|news_img|image|photo|article|body|content|entry|hentry|page|pagination|post|text|cont_txt|aricle|image_src/i,
  negativeRe: /landingㅣbtm|like|rel|copyright|art_btm|list|twobox|like|rel|links|emotion|table|arl_view|writer|date|combx|comment|captcha|contact|foot|footer|footnote|link|media|meta|promo|related|scroll|shoutbox|sponsor|utility|tags|widget|tip|dialog|title|ad|Ad|tit|subject/i,
  neverRe: /widget-inline-editors-picks|news_like|news_tag|news_rel|news_copyright_links|best_nw|article_tit|Ad|tit|extra|landingㅣbtm|editor|profile|like|rel|copyright/i,
  divToPElementsRe: /<(a|figure|blockquote|dl|div|img|ol|p|pre|table|ul)/i,
  replaceBrsRe: /(<br[^>]*>[ \n\r\t]*){2,}/gi,
...
function getClassWeight(node) {
  ...
  if (node.attr('class') === 'ab_photo photo_center ') weight += 50;
