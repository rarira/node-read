...
var regexps = {
  unlikelyCandidatesRe: /combx|pager|comment|disqus|foot|header|menu|meta|nav|rss|shoutbox|sidebar|sponsor|share|bookmark|social|advert|leaderboard|instapaper|unrelated/i,
  okMaybeItsACandidateRe: /and|article|body|column|main|figure|content|image|entry|src|post/i,
  positiveRe: /ab|caption|interview|question|answer|news_img|image|photo|article|body|content|entry|hentry|page|pagination|post|text|cont_txt|aricle|image_src/i,
  ...
  neverRe: /widget-inline-editors-picks|news_like|news_tag|news_rel|news_copyright_links|best_nw|Ad|tit|extra|landingㅣbtm|editor|profile|like|rel|copyright/i,
